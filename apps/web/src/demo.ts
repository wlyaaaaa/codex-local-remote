...
export const demoModels: ModelOption[] = [
  ...
  },
  {
    ...
    displayName: "自定义模型",
    description: "验证自定义提供方名称不会被误标（演示样例）",
...
export const demoThreads: ThreadSummary[] = [
  ...
  {
    id: "thread-desktop-running",
    title: "Desktop 创建：实时同步验收",
    projectId: "project-notes",
    cwdLabel: "…/research-notes",
    mode: "managed",
    state: "running",
  ...
  {
    id: "thread-home-fourth",
    title: "Desktop 创建：第四个实时任务",
    projectId: "project-console",
    cwdLabel: "…/mobile-console",
    mode: "managed",
    state: "running",
  ...
  {
    id: "thread-home-fifth",
    title: "Desktop 创建：第五个实时任务",
    projectId: "project-notes",
    cwdLabel: "…/research-notes",
    mode: "managed",
    state: "running",
...
export const demoThreadDetail: ThreadDetail = {
  ...
  items: [
    ...
    },
    {
      ...
      occurrences: 12,
      occurrenceDetails: Array.from({ length: 12 }, (_, index) => ({
        id: `t-2-${index + 1}`,
        ...
        detail: `第 ${index + 1} 项界面更新已完成，并通过组件级检查。`,
        createdAt: isoAgo(26 - index),
      })),
      createdAt: isoAgo(14),
    },
    {
      ...
      steps: [
        ...
        { text: "收敛对话信息层级", status: "completed" },
        { text: "完善输入区实时控制", status: "inProgress" },
        { text: "验证动态审批与提问", status: "pending" },
        { text: "验证文件预览和下载", status: "pending" },
        { text: "复核 412×915 响应式布局", status: "pending" },
        { text: "完成发布前检查", status: "pending" },
      ],
      createdAt: isoAgo(13),
    },
    {
